<?php
class ControllerExtensionModuleMRPsupplierorder extends Controller
{
	private $code = 'MRPsupplierorder';
	private $error = array();
	...
	public function index(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_extension_MRP_MRPsupplierorder->modifyTable($this->request->post['fields']);
	...
	// DATA
		...
		$data['fields'] = $this->model_extension_MRP_MRPsupplierorder->getTableCustomColumns();
	...
	public function install(){
		...
		$this->model_extension_MRP_MRPsupplierorder->install();
		
		$this->load->model('setting/setting');
		$this->model_setting_setting->editSetting('module_MRPsupplierorder', ['module_MRPsupplierorder_status' => 1]);
	}

	public function uninstall(){
		$this->load->model('setting/setting');
		$this->model_setting_setting->deleteSetting('module_MRPsupplierorder');
		
		$this->load->model('extension/MRP/MRPsupplierorder');
		$this->model_extension_MRP_MRPsupplierorder->uninstall();
	}

	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->session->data['success'] = $this->language->get('text_success');
				...
				if (isset($this->error['linemgr'])) {
					$data['error_linemgr'] = $this->error['linemgr'];
				} else {
					$data['linemgr'] = '';
				}
	...
	protected function getForm() {
		...
		if (isset($this->request->post['email'])) {
			...
			$data['email'] = '';
				...
				$data['allUsers'] = $this->model_user_user->getUsers();
			
				if (isset($this->request->post['linemgr'])) {
					$data['linemgr'] = $this->request->post['linemgr'];
				} elseif (!empty($user_info)) {
					$data['linemgr'] = $user_info['linemgr'];
				} else {
					$data['linemgr'] = '';
				}

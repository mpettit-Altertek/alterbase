	...
	// BREADCRUMBS
		...
		if(!is_null($id)){
			...
			/* INSTER STATMODULES HERE */
				...
				$data['statmodules'][] = $this->load->controller('extension/MRP/weeereport');
			

				$data['statmodules'][] = $this->load->controller('extension/MRP/productweightreport');
			

				$data['statmodules'][] = $this->load->controller('extension/MRP/lithiumreport');
		...
		$data['modules'] = array();
				...
				$data['modules'][] = $this->load->controller('extension/MRP/supplier/productview_suppliers');
			

				$data['modules'][] = $this->load->controller('extension/MRP/stock');

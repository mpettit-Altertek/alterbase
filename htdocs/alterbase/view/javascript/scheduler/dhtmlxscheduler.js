...
!(function () {
    ...
    -1 != navigator.userAgent.indexOf("Macintosh") && (_isMacOS = !0),
        ...
        (function () {
            ...
            function h(t, e, i, n) {
                return "object" != typeof t && (t = { text: t, type: e, expire: i, id: n }), (t.id = t.id || u.uid()), (t.expire = t.expire || u.expire), t;
            }
            var c = null;
    ...
    (dataProcessor.prototype = {
        setTransactionMode: function (t, e) {
            "object" == typeof t ? ((this._tMode = t.mode || this._tMode), void 0 !== t.headers && (this._headers = t.headers), void 0 !== t.payload && (this._payload = t.payload)) : ((this._tMode = t), (this._tSend = e)),
                ...
                this._headers && !this._headers["Content-Type"] && (this._headers["Content-Type"] = "application/x-www-form-urlencoded");
        },
        escape: function (t) {
        ...
        (Scheduler.getSchedulerInstance = function () {
            ...
            (g.init = function (t, e, i) {
                ...
                (g.set_sizes = function () {
                    ...
                    g._is_material_skin()
                        ? (a || ((a = document.createElement("div")), (a.className = "dhx_cal_scale_placeholder"), this.$container.insertBefore(a, this._els.dhx_cal_header[0])),
                    ...
                    if (((e = e || t.target || t.srcElement), !this.config.readonly)) {
                        ...
                        switch (i) {
                            ...
                            case "dhx_cal_event_clear":
                                ...
                                this.config.details_on_dblclick || this._table_view || !this.getEvent(n)._timed || !this.config.select ? this.showLightbox(n,false) : this.edit(n);
                                break;
                            case "dhx_time_block":
                ...
                (g._mouse_coords = function (t) {
                    ...
                    (e = this.$env.isIE || (!t.pageX && !t.pageY) ? { x: t.clientX + (i.scrollLeft || n.scrollLeft || 0) - i.clientLeft, y: t.clientY + (i.scrollTop || n.scrollTop || 0) - i.clientTop } : { x: t.pageX, y: t.pageY }),
                            ...
                            if ((g.matrix && (o = g.matrix[g._mode]), (o = o || { x_step: 1, x_unit: "day" }), "move" == this._drag_mode))
                                (i = this._min_date.valueOf() + 6e4 * (e.y * this.config.time_step + 24 * e.x * 60)),
                                    ...
                                    e._ignores && this.config.preserve_length && this._table_view
                                        ? ((i = g._correct_drag_start_date(i)), (n = g._correct_drag_end_date(i, this._drag_event._event_length)))
                                        ...
                                        ? ((E = new Date(g._min_date)),
                                          e._ignores && this.config.preserve_length && this._table_view
                                              ? ((E = new Date(g._correct_drag_start_date(E))),
                                                ...
                                                (n = new Date(1 * E + this._get_fictional_event_length(E, this._drag_event._event_length, o))))
                                              : (n = new Date(+E + A)))
                                        : ((n = new Date(g._max_date)),
                                          e._ignores && this.config.preserve_length && this._table_view
                                              ? (o._end_correction && (n = new Date(n.valueOf() - o._end_correction)),
                                                ...
                                                this._ignores_detected && ((E = g.date.add(E, o.x_step, o.x_unit)), (n = new Date(1 * n - this._get_fictional_event_length(n, 0, o, !0))), (n = g.date.add(n, o.x_step, o.x_unit))))
                                              : (E = new Date(+n - A)));
                                }
                                var D = new Date(n - 1);
                            }
                                ...
                                if (this.callEvent("onBeforeEventChanged", [a, t, r, this._drag_event]))
                                    if (((this._drag_id = this._drag_mode = null), r && this.config.edit_on_create)) {
                                        if ((this.unselect(), (this._new_event = new Date()), this._table_view || this.config.details_on_create || !this.config.select || !this.isOneDayEvent(this.getEvent(e))))
                                            return g.callEvent("onDragEnd", [e, i, t]), this.showLightbox(e,r);
                ...
                (g._lame_clone = function (t, e) {
                    ...
                    if (t && "object" == typeof t) {
                        for (a = Object.create(t), n = [Array, Date, Number, String, Boolean], i = 0; i < n.length; i++) t instanceof n[i] && (a = i ? new n[i](t) : new n[i]());
                        e.push(t, a);
                ...
                (function () {
                    ...
                    g._getFocusableNodes = function (a) {
                        for (
                            var r = a.querySelectorAll(["a[href]", "area[href]", "input", "select", "textarea", "button", "iframe", "object", "embed", "[tabindex]", "[contenteditable]"].join(", ")),
                            ...
                            (n &&
                                (d.onreadystatechange = function () {
                                    if (4 == d.readyState || (l && 3 == d.readyState)) {
                                        ...
                                        window.setTimeout(function () {
                                            "function" == typeof a && a.apply(window, [{ xmlDoc: d, filePath: e }]), r && (void 0 !== r.postData ? this.postLong(r.url, r.postData, a) : this.getLong(r.url, a)), (a = null), (d = null);
                                        }, 1);
                                    }
                                }),
            ...
            (g.date = {
                ...
                (g.addEvent = function (t, e, i, n, a) {
                    ...
                    var r = t;
                    1 != arguments.length && ((r = a || {}), (r.start_date = t), (r.end_date = e), (r.text = i), (r.id = n)),
                        (r.id = r.id || g.uid()),
                        (r.text = r.text || ""),
                        ...
                        if (e) this._colsS.heights = n;
                            ...
                            if (s.rows) {
                                for (var o = 0; o < s.rows.length; o++) {
                                    ...
                                    if (a[o] * i > l) {
                                        var _ = l;
                                        1 * this.config.max_month_events !== this.config.max_month_events || a[o] <= this.config.max_month_events
                                            ? (_ = a[o] * i)
                ...
                (g._render_v_bar = function (t, e, i, n, a, r, s, o, d) {
                    ...
                    return (d || !1 === t._drag_resize) && (S = "dhx_resize_denied " + S), (k += '<div class="' + S + '" style=" width:' + w + "px;" + (d ? " margin-top:-1px;" : "") + f + v + '" ></div>'), (A.innerHTML = k), A;
                }),
                ...
                (g.showEvent = function (t, e) {
                    ...
                    if (((e = e || g._mode), n && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [n, e])))) {
                        ...
                        var s = n.color,
                            o = n.textColor;
                        if (
                            (g.config.highlight_displayed_event && ((n.color = g.config.displayed_event_color), (n.textColor = g.config.displayed_event_text_color)),
                ...
                (g.form_blocks = {
                    ...
                    select: {
                        render: function (t) {
                            for (
                                var e = g._lightbox_controls.defaults.select, i = e ? e.height : 23, n = (t.height || i || "23") + "px", a = "<div class='dhx_cal_ltext' style='height:" + n + ";'><select style='width:100%;'>", r = 0;
                                r < t.options.length;
                                r++
                            )
                    ...
                    time: {
                        ...
                        get_value: function (t, e, i) {
                            ...
                            if (
                                ((e.start_date = new Date(n[a[3]].value, n[a[2]].value, n[a[1]].value, 0, n[a[0]].value)),
                ...
                (g.showLightbox = function (t,n) {
                    if (t) {
                        if (!this.callEvent("onBeforeLightbox", [t])) return void (this._new_event && (this._new_event = null));
                        var e = this.getLightbox();
                        this.showCover(e), this._fill_lightbox(t, e), this._waiAria.lightboxVisibleAttr(e), this.callEvent("onLightbox", [t,n]);
                    }
                }),
                                    ...
                                    default:
                                        if (e.getAttribute("dhx_button")) g.callEvent("onLightboxButton", [i, e, t]);
                                            ...
                                            -1 != i.indexOf("dhx_custom_button") &&
                                                (-1 != i.indexOf("dhx_custom_button_") ? ((a = e.parentNode.getAttribute("index")), (s = e.parentNode.parentNode)) : ((a = e.getAttribute("index")), (s = e.parentNode), (e = e.firstChild))),
                                                a && ((r = g.form_blocks[g.config.lightbox.sections[a].type]), r.button_click(a, e, s, s.nextSibling));
                                        }
                                }
                        }
                    }),
                    ...
                    if (!this._lightbox) {
                        ...
                        for (var e = this._lightbox_template, i = this.config.buttons_left, n = "", a = 0; a < i.length; a++)
                            (n = this._waiAria.lightboxButtonAttrString(i[a])),
                                (e +=
                                    "<div " + n + " class='dhx_btn_set dhx_" + (g.config.rtl ? "right" : "left") + "_btn_set " + i[a] + "_set'><div dhx_button='1' class='" + i[a] + "'></div><div>" + g.locale.labels[i[a]] + "</div></div>");
